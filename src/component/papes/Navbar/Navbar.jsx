...
export default function Navbar() {
  ...
  const [isServiceButtonContact, setIsHoveringServiceButtonContact] =
    useState(false);
                    ...
                    <li className="nav-item dropdown button-services">
                      <Link
                        ...
                        style={{
                          ...
                          paddingTop: "0.5rem",
                          textDecoration: "none",
                          color: isServiceButtonHovering
                            ? "#000000b3"
                            : "#0000008c",
                        }}
                        onMouseEnter={handleMouseEnterServiceButton}
                        onMouseLeave={handleMouseLeaveServiceButton}
                      >
                        Dịch Vụ
                      </Link>
                      <Link
