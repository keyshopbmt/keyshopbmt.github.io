      ...
      <div className="card text-bg-dark">
        ...
        <div className="dichvu-contact">
          <MDBRow>
            <MDBCol md="8">
              <p>
                Khi bạn mất chìa khóa, đó là một tình huống căng thẳng. Key Shop
                BMT là nơi sửa và làm chìa khóa uy tín ở thành phố Buôn Ma
                Thuột, cung cấp nhiều dịch vụ sửa và làm chìa khóa ở thành phố
                Buôn Ma Thuột và các khu vực lân cận, bao gồm các dịch vụ khẩn
                cấp và không khẩn cấp. Đội ngũ của chúng tôi luôn sẵn sàng trợ
                giúp bạn.
              </p>
            </MDBCol>
            <MDBCol md="2">
