...
export default function Titlecar() {
  return (
    <div className="title-car">
      <h2>
        <b>Dịch vụ sửa và làm chìa khóa Ôtô tại Key Shop Bmt</b>
      </h2>

      <div className="row-title">
        <h4>
          Dịch vụ sửa và làm chìa khóa Ôtô 24/24 :<span>0942975959</span>
        </h4>
        ...
        <ul>
          ...
          <li>Sửa và làm chìa khóa Ôtô chuyên nghiệp</li>
        </ul>
