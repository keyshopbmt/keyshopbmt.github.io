                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-7">
							<div className="group_image_holder type_1">
								...
								<img className="main_img" src="assets/services/image6.png" alt=""/>
								<img className="sub_img" src="assets/services/image5.png" alt=""/>
								<img className="sub_img2" src="assets/services/image4.png" alt=""/>
							</div>
						</div>
